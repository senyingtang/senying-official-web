...
- seed 由 migrations `0015_seed_content.sql` / `0016_marketing_site_settings.sql` 提供，`[db.seed]` 關閉。
...
pnpm db:smoke           # migrations / seed / 6 支 SQL smoke test / PostgREST + GoTrue RLS
